             ...
             <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
                ...
                `}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <div className="flex justify-between mb-2"><label htmlFor="plinko-rows" className="text-xs text-slate-400 font-bold uppercase block">Rows</label><span className="text-xs font-bold text-white">{rowCount}</span></div>
                            <input id="plinko-rows" name="rows" type="range" min="8" max="16" step="1" value={rowCount} onChange={(e) => setRowCount(parseInt(e.target.value))} className={`w-full h-2 bg-slate-800 rounded-lg appearance-none cursor-pointer accent-${theme.bucket}`} />
